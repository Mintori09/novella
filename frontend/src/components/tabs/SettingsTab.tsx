...
import { GetConfig, UpdateConfig, SelectDirectory, ClearCache, GetCacheInfo } from '../../../wailsjs/go/main/App'
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-5">
        <div className="space-y-2">
          <label className="text-xs text-muted-foreground uppercase tracking-wider">Workers</label>
        ...
        <div className="space-y-2">
          <label className="text-xs text-muted-foreground uppercase tracking-wider">Chunk Size</label>
          <input
            type="number"
            value={chunkSize}
            onChange={(e) => {
        ...
        <div className="space-y-2">
          <label className="text-xs text-muted-foreground uppercase tracking-wider">Review Step</label>
          <button
            onClick={() => {
        ...
        <div className="space-y-2">
          <label className="text-xs text-muted-foreground uppercase tracking-wider">Output Directory</label>
          <div className="flex gap-2">
            <input
              type="text"
              value={outputDir}
        ...
        <div className="space-y-2">
          <label className="text-xs text-muted-foreground uppercase tracking-wider">Theme</label>
          <div className="flex gap-2">
        ...
        <div className="space-y-2 pt-2 border-t border-border">
          <label className="text-xs text-muted-foreground uppercase tracking-wider">Cache</label>
